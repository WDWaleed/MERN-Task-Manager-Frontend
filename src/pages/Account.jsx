    ...
    <div className="bg-main-bg text-primary flex min-h-[calc(100vh-4.5rem)] items-center justify-center">
      {isLoading ? (
        ...
        <div className="bg-component-bg mx-8 w-full max-w-md rounded-lg p-8 shadow-lg">
          <h2 className="text-primary q mb-6 text-center text-3xl font-bold">
            Account Details
          </h2>
          <div>
            <p>Name: {user?.name}</p>
            ...
            <button
              ...
              className="bg-bright-blue text-button mt-6 w-full cursor-pointer rounded-sm px-4 py-2 transition-colors duration-200 hover:bg-blue-600"
            >
              Reset Password
            </button>
          </div>
